...
eia_url <- paste0("https://api.eia.gov/v2/international/data/?api_key=", Sys.getenv("EIA_API_KEY_INTER"),"&frequency=monthly&data[0]=value&sort[0][column]=period&sort[0][direction]=desc","&offset=0&length=100000",paste0("&facets[countryRegionId][]=", c("OPEC", "USA", "RUS", "CHN", "SAU", "IRQ","IRN", "ARE", "KWT", "VEN", "NGA", "LBY","DZA", "NOR", "CAN", "MEX", "BRA", "KAZ"), collapse = ""),"&facets[productId][]=57")

# Gaz Infrastructure Europe inputs
gie_geo_area <- c("AT", "BE", "BG", "HR", "CZ", "DK", "FR", "DE","HU", "IE", "IT", "LV", "NL", "PL", "PT", "RO","SK", "ES", "SE", "GB", "UA")
...
input_database <- tribble(
  ...
  "GOVDEPMIO_EUREA21",       "ea20_govde_nsa_es",      "Governement Debt for Euro Area (20 Countries), Millions Euros, Not Adjusted",                                                  "eurostat", "Q",         NA,      "eur",  "NA",
  "GOVDEPPC_GDPEA21",        "ea20_govde_nsa_pg_es",   "Governement Debt for Euro Area (20 Countries), Percentage of GDP, Not Adjusted",                                               "eurostat", "Q",         NA,      "prc",  "NA",
  ...
  "TTF=F",                   "fut_ttf_natural_gas",   "TTF Natural gas futures (front contract)",                           "yahoo",       "D",   NA,   "eur",   "NA",
  ...
  "COINVUS",                "us_crude_inv",          "US Crude Oil Inventories, Weekly, Thousands of Barrels, Not Adjusted", "investing", "W",   NA,   "bl",    "NA",
  "NGSTORUS",               "us_natgas_storage",     "US Natural Gas Storage, Weekly, Billion Cubic Feet, Not Adjusted", "    investing", "W",   NA,   "cf",    "NA",
  
  # Production 
  "COPR_OPEC",  "opec_crude_prod",  "Crude Oil Production including Lease Condensate for OPEC, Thousand Barrels per Day, Not Adjusted",                   "eia", "M", NA, "bl", "NA",
  "COPR_USA",   "us_crude_prod",    "Crude Oil Production including Lease Condensate for United States, Thousand Barrels per Day, Not Adjusted",          "eia", "M", NA, "bl", "NA",
  "COPR_RUS",   "ru_crude_prod",    "Crude Oil Production including Lease Condensate for Russia, Thousand Barrels per Day, Not Adjusted",                 "eia", "M", NA, "bl", "NA",
  "COPR_CHN",   "cn_crude_prod",    "Crude Oil Production including Lease Condensate for China, Thousand Barrels per Day, Not Adjusted",                  "eia", "M", NA, "bl", "NA",
  "COPR_SAU",   "sau_crude_prod",   "Crude Oil Production including Lease Condensate for Saudi Arabia, Thousand Barrels per Day, Not Adjusted",           "eia", "M", NA, "bl", "NA",
  "COPR_IRQ",   "irq_crude_prod",   "Crude Oil Production including Lease Condensate for Iraq, Thousand Barrels per Day, Not Adjusted",                   "eia", "M", NA, "bl", "NA",
  "COPR_IRN",   "irn_crude_prod",   "Crude Oil Production including Lease Condensate for Iran, Thousand Barrels per Day, Not Adjusted",                   "eia", "M", NA, "bl", "NA",
  "COPR_ARE",   "are_crude_prod",   "Crude Oil Production including Lease Condensate for United Arab Emirates, Thousand Barrels per Day, Not Adjusted",   "eia", "M", NA, "bl", "NA",
  "COPR_KWT",   "kwt_crude_prod",   "Crude Oil Production including Lease Condensate for Kuwait, Thousand Barrels per Day, Not Adjusted",                 "eia", "M", NA, "bl", "NA",
  "COPR_VEN",   "ven_crude_prod",   "Crude Oil Production including Lease Condensate for Venezuela, Thousand Barrels per Day, Not Adjusted",              "eia", "M", NA, "bl", "NA",
  "COPR_NGA",   "nga_crude_prod",   "Crude Oil Production including Lease Condensate for Nigeria, Thousand Barrels per Day, Not Adjusted",                "eia", "M", NA, "bl", "NA",
  "COPR_LBY",   "lby_crude_prod",   "Crude Oil Production including Lease Condensate for Libya, Thousand Barrels per Day, Not Adjusted",                  "eia", "M", NA, "bl", "NA",
  "COPR_DZA",   "dza_crude_prod",   "Crude Oil Production including Lease Condensate for Algeria, Thousand Barrels per Day, Not Adjusted",                "eia", "M", NA, "bl", "NA",
  "COPR_NOR",   "nor_crude_prod",   "Crude Oil Production including Lease Condensate for Norway, Thousand Barrels per Day, Not Adjusted",                 "eia", "M", NA, "bl", "NA",
  "COPR_CAN",   "can_crude_prod",   "Crude Oil Production including Lease Condensate for Canada, Thousand Barrels per Day, Not Adjusted",                 "eia", "M", NA, "bl", "NA",
  "COPR_MEX",   "mex_crude_prod",   "Crude Oil Production including Lease Condensate for Mexico, Thousand Barrels per Day, Not Adjusted",                 "eia", "M", NA, "bl", "NA",
  "COPR_BRA",   "bra_crude_prod",   "Crude Oil Production including Lease Condensate for Brazil, Thousand Barrels per Day, Not Adjusted",                 "eia", "M", NA, "bl", "NA",
  "COPR_KAZ",   "kaz_crude_prod",   "Crude Oil Production including Lease Condensate for Kazakhstan, Thousand Barrels per Day, Not Adjusted",             "eia", "M", NA, "bl", "NA",
  
  # Supply
  "RICBH",       "us_rig_count",   "Baker Hughes US Rig Count, Total Oil & Gas Rigs, Not Adjusted",                                                    "investing", "W", NA, "rig", "NA",
  
  # Europe Gaz data
  "GAZISFR",    "gis_fr",      "Gas In Storage France, Daily, Terawatt-Hour, Not Adjusted",                               "gie",   "D",        NA,    "twh", "NA",
  "GAZISDE",    "gis_de",      "Gas In Storage Germany, Daily, Terawatt-Hour, Not Adjusted",                              "gie",   "D",        NA,    "twh", "NA",
  "GAZISIT",    "gis_it",      "Gas In Storage Italy, Daily, Terawatt-Hour, Not Adjusted",                                "gie",   "D",        NA,    "twh", "NA",
  "GAZISES",    "gis_es",      "Gas In Storage Spain, Daily, Terawatt-Hour, Not Adjusted",                                "gie",   "D",        NA,    "twh", "NA",
  "GAZISBE",    "gis_be",      "Gas In Storage Belgium, Daily, Terawatt-Hour, Not Adjusted",                              "gie",   "D",        NA,    "twh", "NA",
  "GAZISNL",    "gis_nl",      "Gas In Storage Netherlands, Daily, Terawatt-Hour, Not Adjusted",                          "gie",   "D",        NA,    "twh", "NA",
  "GAZISPL",    "gis_pl",      "Gas In Storage Poland, Daily, Terawatt-Hour, Not Adjusted",                               "gie",   "D",        NA,    "twh", "NA",
  "GAZISHU",    "gis_hu",      "Gas In Storage Hungary, Daily, Terawatt-Hour, Not Adjusted",                              "gie",   "D",        NA,    "twh", "NA",
  "GAZISPT",    "gis_pt",      "Gas In Storage Portugal, Daily, Terawatt-Hour, Not Adjusted",                             "gie",   "D",        NA,    "twh", "NA",
  "GAZISAT",    "gis_at",      "Gas In Storage Austria, Daily, Terawatt-Hour, Not Adjusted",                              "gie",   "D",        NA,    "twh", "NA",
  "GAZISSK",    "gis_sk",      "Gas In Storage Slovakia, Daily, Terawatt-Hour, Not Adjusted",                             "gie",   "D",        NA,    "twh", "NA",
  "GAZISCZ",    "gis_cz",      "Gas In Storage Czech Republic, Daily, Terawatt-Hour, Not Adjusted",                       "gie",   "D",        NA,    "twh", "NA",
  "GAZISRO",    "gis_ro",      "Gas In Storage Romania, Daily, Terawatt-Hour, Not Adjusted",                              "gie",   "D",        NA,    "twh", "NA",
  "GAZISBG",    "gis_bg",      "Gas In Storage Bulgaria, Daily, Terawatt-Hour, Not Adjusted",                             "gie",   "D",        NA,    "twh", "NA",
  "GAZISLV",    "gis_lv",      "Gas In Storage Latvia, Daily, Terawatt-Hour, Not Adjusted",                               "gie",   "D",        NA,    "twh", "NA",
  "GAZISHR",    "gis_hr",      "Gas In Storage Croatia, Daily, Terawatt-Hour, Not Adjusted",                              "gie",   "D",        NA,    "twh", "NA",
  "GAZISSE",    "gis_se",      "Gas In Storage Sweden, Daily, Terawatt-Hour, Not Adjusted",                               "gie",   "D",        NA,    "twh", "NA",
  "GAZISDK",    "gis_dk",      "Gas In Storage Denmark, Daily, Terawatt-Hour, Not Adjusted",                              "gie",   "D",        NA,    "twh", "NA",
  "GAZISIE",    "gis_ie",      "Gas In Storage Ireland, Daily, Terawatt-Hour, Not Adjusted",                              "gie",   "D",        NA,    "twh", "NA",
  "GAZISGB",    "gis_gb",      "Gas In Storage United Kingdom, Daily, Terawatt-Hour, Not Adjusted",                       "gie",   "D",        NA,    "twh", "NA",
  "GAZISUA",    "gis_ua",      "Gas In Storage Ukraine, Daily, Terawatt-Hour, Not Adjusted",                              "gie",   "D",        NA,    "twh", "NA",
  "GAZWGVFR",   "wgv_fr",      "Working Gas Volume France, Daily, Terawatt-Hour, Not Adjusted",                            "gie",   "D",        NA,    "twh", "NA",
  "GAZWGVDE",   "wgv_de",      "Working Gas Volume Germany, Daily, Terawatt-Hour, Not Adjusted",                           "gie",   "D",        NA,    "twh", "NA",
  "GAZWGVIT",   "wgv_it",      "Working Gas Volume Italy, Daily, Terawatt-Hour, Not Adjusted",                             "gie",   "D",        NA,    "twh", "NA",
  "GAZWGVES",   "wgv_es",      "Working Gas Volume Spain, Daily, Terawatt-Hour, Not Adjusted",                             "gie",   "D",        NA,    "twh", "NA",
  "GAZWGVBE",   "wgv_be",      "Working Gas Volume Belgium, Daily, Terawatt-Hour, Not Adjusted",                           "gie",   "D",        NA,    "twh", "NA",
  "GAZWGVNL",   "wgv_nl",      "Working Gas Volume Netherlands, Daily, Terawatt-Hour, Not Adjusted",                       "gie",   "D",        NA,    "twh", "NA",
  "GAZWGVPL",   "wgv_pl",      "Working Gas Volume Poland, Daily, Terawatt-Hour, Not Adjusted",                            "gie",   "D",        NA,    "twh", "NA",
  "GAZWGVHU",   "wgv_hu",      "Working Gas Volume Hungary, Daily, Terawatt-Hour, Not Adjusted",                           "gie",   "D",        NA,    "twh", "NA",
  "GAZWGVPT",   "wgv_pt",      "Working Gas Volume Portugal, Daily, Terawatt-Hour, Not Adjusted",                          "gie",   "D",        NA,    "twh", "NA",
  "GAZWGVAT",   "wgv_at",      "Working Gas Volume Austria, Daily, Terawatt-Hour, Not Adjusted",                           "gie",   "D",        NA,    "twh", "NA",
  "GAZWGVSK",   "wgv_sk",      "Working Gas Volume Slovakia, Daily, Terawatt-Hour, Not Adjusted",                          "gie",   "D",        NA,    "twh", "NA",
  "GAZWGVCZ",   "wgv_cz",      "Working Gas Volume Czech Republic, Daily, Terawatt-Hour, Not Adjusted",                    "gie",   "D",        NA,    "twh", "NA",
  "GAZWGVRO",   "wgv_ro",      "Working Gas Volume Romania, Daily, Terawatt-Hour, Not Adjusted",                           "gie",   "D",        NA,    "twh", "NA",
  "GAZWGVBG",   "wgv_bg",      "Working Gas Volume Bulgaria, Daily, Terawatt-Hour, Not Adjusted",                          "gie",   "D",        NA,    "twh", "NA",
  "GAZWGVLV",   "wgv_lv",      "Working Gas Volume Latvia, Daily, Terawatt-Hour, Not Adjusted",                            "gie",   "D",        NA,    "twh", "NA",
  "GAZWGVHR",   "wgv_hr",      "Working Gas Volume Croatia, Daily, Terawatt-Hour, Not Adjusted",                           "gie",   "D",        NA,    "twh", "NA",
  "GAZWGVSE",   "wgv_se",      "Working Gas Volume Sweden, Daily, Terawatt-Hour, Not Adjusted",                            "gie",   "D",        NA,    "twh", "NA",
  "GAZWGVDK",   "wgv_dk",      "Working Gas Volume Denmark, Daily, Terawatt-Hour, Not Adjusted",                           "gie",   "D",        NA,    "twh", "NA",
  "GAZWGVIE",   "wgv_ie",      "Working Gas Volume Ireland, Daily, Terawatt-Hour, Not Adjusted",                           "gie",   "D",        NA,    "twh", "NA",
  "GAZWGVGB",   "wgv_gb",      "Working Gas Volume United Kingdom, Daily, Terawatt-Hour, Not Adjusted",                    "gie",   "D",        NA,    "twh", "NA",
  "GAZWGVUA",   "wgv_ua",      "Working Gas Volume Ukraine, Daily, Terawatt-Hour, Not Adjusted",                           "gie",   "D",        NA,    "twh", "NA",
  "GAZFILLFR",  "fill_fr",     "Gas Storage Fill Rate France, Daily, Percent, Not Adjusted",                               "gie",   "D",        NA,    "%",   "NA",
  "GAZFILLDE",  "fill_de",     "Gas Storage Fill Rate Germany, Daily, Percent, Not Adjusted",                              "gie",   "D",        NA,    "%",   "NA",
  "GAZFILLIT",  "fill_it",     "Gas Storage Fill Rate Italy, Daily, Percent, Not Adjusted",                                "gie",   "D",        NA,    "%",   "NA",
  "GAZFILLES",  "fill_es",     "Gas Storage Fill Rate Spain, Daily, Percent, Not Adjusted",                                "gie",   "D",        NA,    "%",   "NA",
  "GAZFILLBE",  "fill_be",     "Gas Storage Fill Rate Belgium, Daily, Percent, Not Adjusted",                              "gie",   "D",        NA,    "%",   "NA",
  "GAZFILLNL",  "fill_nl",     "Gas Storage Fill Rate Netherlands, Daily, Percent, Not Adjusted",                          "gie",   "D",        NA,    "%",   "NA",
  "GAZFILLPL",  "fill_pl",     "Gas Storage Fill Rate Poland, Daily, Percent, Not Adjusted",                               "gie",   "D",        NA,    "%",   "NA",
  "GAZFILLHU",  "fill_hu",     "Gas Storage Fill Rate Hungary, Daily, Percent, Not Adjusted",                              "gie",   "D",        NA,    "%",   "NA",
  "GAZFILLPT",  "fill_pt",     "Gas Storage Fill Rate Portugal, Daily, Percent, Not Adjusted",                             "gie",   "D",        NA,    "%",   "NA",
  "GAZFILLAT",  "fill_at",     "Gas Storage Fill Rate Austria, Daily, Percent, Not Adjusted",                              "gie",   "D",        NA,    "%",   "NA",
  "GAZFILLSK",  "fill_sk",     "Gas Storage Fill Rate Slovakia, Daily, Percent, Not Adjusted",                             "gie",   "D",        NA,    "%",   "NA",
  "GAZFILLCZ",  "fill_cz",     "Gas Storage Fill Rate Czech Republic, Daily, Percent, Not Adjusted",                       "gie",   "D",        NA,    "%",   "NA",
  "GAZFILLRO",  "fill_ro",     "Gas Storage Fill Rate Romania, Daily, Percent, Not Adjusted",                              "gie",   "D",        NA,    "%",   "NA",
  "GAZFILLBG",  "fill_bg",     "Gas Storage Fill Rate Bulgaria, Daily, Percent, Not Adjusted",                             "gie",   "D",        NA,    "%",   "NA",
  "GAZFILLLV",  "fill_lv",     "Gas Storage Fill Rate Latvia, Daily, Percent, Not Adjusted",                               "gie",   "D",        NA,    "%",   "NA",
  "GAZFILLHR",  "fill_hr",     "Gas Storage Fill Rate Croatia, Daily, Percent, Not Adjusted",                              "gie",   "D",        NA,    "%",   "NA",
  "GAZFILLSE",  "fill_se",     "Gas Storage Fill Rate Sweden, Daily, Percent, Not Adjusted",                               "gie",   "D",        NA,    "%",   "NA",
  "GAZFILLDK",  "fill_dk",     "Gas Storage Fill Rate Denmark, Daily, Percent, Not Adjusted",                              "gie",   "D",        NA,    "%",   "NA",
  "GAZFILLIE",  "fill_ie",     "Gas Storage Fill Rate Ireland, Daily, Percent, Not Adjusted",                              "gie",   "D",        NA,    "%",   "NA",
  "GAZFILLGB",  "fill_gb",     "Gas Storage Fill Rate United Kingdom, Daily, Percent, Not Adjusted",                       "gie",   "D",        NA,    "%",   "NA",
  "GAZFILLUA",  "fill_ua",     "Gas Storage Fill Rate Ukraine, Daily, Percent, Not Adjusted",                              "gie",   "D",        NA,    "%",   "NA",
  "GAZINJFR",   "inj_fr",      "Gas Injection France, Daily, Terawatt-Hour, Not Adjusted",                                 "gie",   "D",        NA,    "twh", "NA",
  "GAZINJDE",   "inj_de",      "Gas Injection Germany, Daily, Terawatt-Hour, Not Adjusted",                                "gie",   "D",        NA,    "twh", "NA",
  "GAZINJIT",   "inj_it",      "Gas Injection Italy, Daily, Terawatt-Hour, Not Adjusted",                                  "gie",   "D",        NA,    "twh", "NA",
  "GAZINJES",   "inj_es",      "Gas Injection Spain, Daily, Terawatt-Hour, Not Adjusted",                                  "gie",   "D",        NA,    "twh", "NA",
  "GAZINJBE",   "inj_be",      "Gas Injection Belgium, Daily, Terawatt-Hour, Not Adjusted",                                "gie",   "D",        NA,    "twh", "NA",
  "GAZINJNL",   "inj_nl",      "Gas Injection Netherlands, Daily, Terawatt-Hour, Not Adjusted",                            "gie",   "D",        NA,    "twh", "NA",
  "GAZINJPL",   "inj_pl",      "Gas Injection Poland, Daily, Terawatt-Hour, Not Adjusted",                                 "gie",   "D",        NA,    "twh", "NA",
  "GAZINJHU",   "inj_hu",      "Gas Injection Hungary, Daily, Terawatt-Hour, Not Adjusted",                                "gie",   "D",        NA,    "twh", "NA",
  "GAZINJPT",   "inj_pt",      "Gas Injection Portugal, Daily, Terawatt-Hour, Not Adjusted",                               "gie",   "D",        NA,    "twh", "NA",
  "GAZINJAT",   "inj_at",      "Gas Injection Austria, Daily, Terawatt-Hour, Not Adjusted",                                "gie",   "D",        NA,    "twh", "NA",
  "GAZINJSK",   "inj_sk",      "Gas Injection Slovakia, Daily, Terawatt-Hour, Not Adjusted",                               "gie",   "D",        NA,    "twh", "NA",
  "GAZINJCZ",   "inj_cz",      "Gas Injection Czech Republic, Daily, Terawatt-Hour, Not Adjusted",                         "gie",   "D",        NA,    "twh", "NA",
  "GAZINJRO",   "inj_ro",      "Gas Injection Romania, Daily, Terawatt-Hour, Not Adjusted",                                "gie",   "D",        NA,    "twh", "NA",
  "GAZINJBG",   "inj_bg",      "Gas Injection Bulgaria, Daily, Terawatt-Hour, Not Adjusted",                               "gie",   "D",        NA,    "twh", "NA",
  "GAZINJLV",   "inj_lv",      "Gas Injection Latvia, Daily, Terawatt-Hour, Not Adjusted",                                 "gie",   "D",        NA,    "twh", "NA",
  "GAZINJHR",   "inj_hr",      "Gas Injection Croatia, Daily, Terawatt-Hour, Not Adjusted",                                "gie",   "D",        NA,    "twh", "NA",
  "GAZINJSE",   "inj_se",      "Gas Injection Sweden, Daily, Terawatt-Hour, Not Adjusted",                                 "gie",   "D",        NA,    "twh", "NA",
  "GAZINJDK",   "inj_dk",      "Gas Injection Denmark, Daily, Terawatt-Hour, Not Adjusted",                                "gie",   "D",        NA,    "twh", "NA",
  "GAZINJIE",   "inj_ie",      "Gas Injection Ireland, Daily, Terawatt-Hour, Not Adjusted",                                "gie",   "D",        NA,    "twh", "NA",
  "GAZINJGB",   "inj_gb",      "Gas Injection United Kingdom, Daily, Terawatt-Hour, Not Adjusted",                         "gie",   "D",        NA,    "twh", "NA",
  "GAZINJUA",   "inj_ua",      "Gas Injection Ukraine, Daily, Terawatt-Hour, Not Adjusted",                                "gie",   "D",        NA,    "twh", "NA",
  "GAZWITFR",   "wit_fr",      "Gas Withdrawal France, Daily, Terawatt-Hour, Not Adjusted",                                "gie",   "D",        NA,    "twh", "NA",
  "GAZWITDE",   "wit_de",      "Gas Withdrawal Germany, Daily, Terawatt-Hour, Not Adjusted",                               "gie",   "D",        NA,    "twh", "NA",
  "GAZWITIT",   "wit_it",      "Gas Withdrawal Italy, Daily, Terawatt-Hour, Not Adjusted",                                 "gie",   "D",        NA,    "twh", "NA",
  "GAZWITES",   "wit_es",      "Gas Withdrawal Spain, Daily, Terawatt-Hour, Not Adjusted",                                 "gie",   "D",        NA,    "twh", "NA",
  "GAZWITBE",   "wit_be",      "Gas Withdrawal Belgium, Daily, Terawatt-Hour, Not Adjusted",                               "gie",   "D",        NA,    "twh", "NA",
  "GAZWITNL",   "wit_nl",      "Gas Withdrawal Netherlands, Daily, Terawatt-Hour, Not Adjusted",                           "gie",   "D",        NA,    "twh", "NA",
  "GAZWITPL",   "wit_pl",      "Gas Withdrawal Poland, Daily, Terawatt-Hour, Not Adjusted",                                "gie",   "D",        NA,    "twh", "NA",
  "GAZWITHU",   "wit_hu",      "Gas Withdrawal Hungary, Daily, Terawatt-Hour, Not Adjusted",                               "gie",   "D",        NA,    "twh", "NA",
  "GAZWITPT",   "wit_pt",      "Gas Withdrawal Portugal, Daily, Terawatt-Hour, Not Adjusted",                              "gie",   "D",        NA,    "twh", "NA",
  "GAZWITAT",   "wit_at",      "Gas Withdrawal Austria, Daily, Terawatt-Hour, Not Adjusted",                               "gie",   "D",        NA,    "twh", "NA",
  "GAZWITSK",   "wit_sk",      "Gas Withdrawal Slovakia, Daily, Terawatt-Hour, Not Adjusted",                              "gie",   "D",        NA,    "twh", "NA",
  "GAZWITCZ",   "wit_cz",      "Gas Withdrawal Czech Republic, Daily, Terawatt-Hour, Not Adjusted",                        "gie",   "D",        NA,    "twh", "NA",
  "GAZWITRO",   "wit_ro",      "Gas Withdrawal Romania, Daily, Terawatt-Hour, Not Adjusted",                               "gie",   "D",        NA,    "twh", "NA",
  "GAZWITBG",   "wit_bg",      "Gas Withdrawal Bulgaria, Daily, Terawatt-Hour, Not Adjusted",                              "gie",   "D",        NA,    "twh", "NA",
  "GAZWITLV",   "wit_lv",      "Gas Withdrawal Latvia, Daily, Terawatt-Hour, Not Adjusted",                                "gie",   "D",        NA,    "twh", "NA",
  "GAZWITHR",   "wit_hr",      "Gas Withdrawal Croatia, Daily, Terawatt-Hour, Not Adjusted",                               "gie",   "D",        NA,    "twh", "NA",
  "GAZWITSE",   "wit_se",      "Gas Withdrawal Sweden, Daily, Terawatt-Hour, Not Adjusted",                                "gie",   "D",        NA,    "twh", "NA",
  "GAZWITDK",   "wit_dk",      "Gas Withdrawal Denmark, Daily, Terawatt-Hour, Not Adjusted",                               "gie",   "D",        NA,    "twh", "NA",
  "GAZWITIE",   "wit_ie",      "Gas Withdrawal Ireland, Daily, Terawatt-Hour, Not Adjusted",                               "gie",   "D",        NA,    "twh", "NA",
  "GAZWITGB",   "wit_gb",      "Gas Withdrawal United Kingdom, Daily, Terawatt-Hour, Not Adjusted",                        "gie",   "D",        NA,    "twh", "NA",
  "GAZWITUA",   "wit_ua",      "Gas Withdrawal Ukraine, Daily, Terawatt-Hour, Not Adjusted",                               "gie",   "D",        NA,    "twh", "NA",
  "GAZNWITFR",  "nwit_fr",     "Gas Net Withdrawal France, Daily, Terawatt-Hour, Not Adjusted",                            "gie",   "D",        NA,    "twh", "NA",
  "GAZNWITDE",  "nwit_de",     "Gas Net Withdrawal Germany, Daily, Terawatt-Hour, Not Adjusted",                           "gie",   "D",        NA,    "twh", "NA",
  "GAZNWITIT",  "nwit_it",     "Gas Net Withdrawal Italy, Daily, Terawatt-Hour, Not Adjusted",                             "gie",   "D",        NA,    "twh", "NA",
  "GAZNWITES",  "nwit_es",     "Gas Net Withdrawal Spain, Daily, Terawatt-Hour, Not Adjusted",                             "gie",   "D",        NA,    "twh", "NA",
  "GAZNWITBE",  "nwit_be",     "Gas Net Withdrawal Belgium, Daily, Terawatt-Hour, Not Adjusted",                           "gie",   "D",        NA,    "twh", "NA",
  "GAZNWITNL",  "nwit_nl",     "Gas Net Withdrawal Netherlands, Daily, Terawatt-Hour, Not Adjusted",                       "gie",   "D",        NA,    "twh", "NA",
  "GAZNWITPL",  "nwit_pl",     "Gas Net Withdrawal Poland, Daily, Terawatt-Hour, Not Adjusted",                            "gie",   "D",        NA,    "twh", "NA",
  "GAZNWITHU",  "nwit_hu",     "Gas Net Withdrawal Hungary, Daily, Terawatt-Hour, Not Adjusted",                           "gie",   "D",        NA,    "twh", "NA",
  "GAZNWITPT",  "nwit_pt",     "Gas Net Withdrawal Portugal, Daily, Terawatt-Hour, Not Adjusted",                          "gie",   "D",        NA,    "twh", "NA",
  "GAZNWITAT",  "nwit_at",     "Gas Net Withdrawal Austria, Daily, Terawatt-Hour, Not Adjusted",                           "gie",   "D",        NA,    "twh", "NA",
  "GAZNWITSK",  "nwit_sk",     "Gas Net Withdrawal Slovakia, Daily, Terawatt-Hour, Not Adjusted",                          "gie",   "D",        NA,    "twh", "NA",
  "GAZNWITCZ",  "nwit_cz",     "Gas Net Withdrawal Czech Republic, Daily, Terawatt-Hour, Not Adjusted",                    "gie",   "D",        NA,    "twh", "NA",
  "GAZNWITRO",  "nwit_ro",     "Gas Net Withdrawal Romania, Daily, Terawatt-Hour, Not Adjusted",                           "gie",   "D",        NA,    "twh", "NA",
  "GAZNWITBG",  "nwit_bg",     "Gas Net Withdrawal Bulgaria, Daily, Terawatt-Hour, Not Adjusted",                          "gie",   "D",        NA,    "twh", "NA",
  "GAZNWITLV",  "nwit_lv",     "Gas Net Withdrawal Latvia, Daily, Terawatt-Hour, Not Adjusted",                            "gie",   "D",        NA,    "twh", "NA",
  "GAZNWITHR",  "nwit_hr",     "Gas Net Withdrawal Croatia, Daily, Terawatt-Hour, Not Adjusted",                           "gie",   "D",        NA,    "twh", "NA",
  "GAZNWITSE",  "nwit_se",     "Gas Net Withdrawal Sweden, Daily, Terawatt-Hour, Not Adjusted",                            "gie",   "D",        NA,    "twh", "NA",
  "GAZNWITDK",  "nwit_dk",     "Gas Net Withdrawal Denmark, Daily, Terawatt-Hour, Not Adjusted",                           "gie",   "D",        NA,    "twh", "NA",
  "GAZNWITIE",  "nwit_ie",     "Gas Net Withdrawal Ireland, Daily, Terawatt-Hour, Not Adjusted",                           "gie",   "D",        NA,    "twh", "NA",
  "GAZNWITGB",  "nwit_gb",     "Gas Net Withdrawal United Kingdom, Daily, Terawatt-Hour, Not Adjusted",                    "gie",   "D",        NA,    "twh", "NA",
  "GAZNWITUA",  "nwit_ua",     "Gas Net Withdrawal Ukraine, Daily, Terawatt-Hour, Not Adjusted",                           "gie",   "D",        NA,    "twh", "NA",
  "GAZCONSFR",  "cons_fr",     "Gas Consumption France, Daily, Terawatt-Hour, Not Adjusted",                               "gie",   "D",        NA,    "twh", "NA",
  "GAZCONSDE",  "cons_de",     "Gas Consumption Germany, Daily, Terawatt-Hour, Not Adjusted",                              "gie",   "D",        NA,    "twh", "NA",
  "GAZCONSIT",  "cons_it",     "Gas Consumption Italy, Daily, Terawatt-Hour, Not Adjusted",                                "gie",   "D",        NA,    "twh", "NA",
  "GAZCONSES",  "cons_es",     "Gas Consumption Spain, Daily, Terawatt-Hour, Not Adjusted",                                "gie",   "D",        NA,    "twh", "NA",
  "GAZCONSBE",  "cons_be",     "Gas Consumption Belgium, Daily, Terawatt-Hour, Not Adjusted",                              "gie",   "D",        NA,    "twh", "NA",
  "GAZCONSNL",  "cons_nl",     "Gas Consumption Netherlands, Daily, Terawatt-Hour, Not Adjusted",                          "gie",   "D",        NA,    "twh", "NA",
  "GAZCONSPL",  "cons_pl",     "Gas Consumption Poland, Daily, Terawatt-Hour, Not Adjusted",                               "gie",   "D",        NA,    "twh", "NA",
  "GAZCONSHU",  "cons_hu",     "Gas Consumption Hungary, Daily, Terawatt-Hour, Not Adjusted",                              "gie",   "D",        NA,    "twh", "NA",
  "GAZCONSPT",  "cons_pt",     "Gas Consumption Portugal, Daily, Terawatt-Hour, Not Adjusted",                             "gie",   "D",        NA,    "twh", "NA",
  "GAZCONSAT",  "cons_at",     "Gas Consumption Austria, Daily, Terawatt-Hour, Not Adjusted",                              "gie",   "D",        NA,    "twh", "NA",
  "GAZCONSSK",  "cons_sk",     "Gas Consumption Slovakia, Daily, Terawatt-Hour, Not Adjusted",                             "gie",   "D",        NA,    "twh", "NA",
  "GAZCONSCZ",  "cons_cz",     "Gas Consumption Czech Republic, Daily, Terawatt-Hour, Not Adjusted",                       "gie",   "D",        NA,    "twh", "NA",
  "GAZCONSRO",  "cons_ro",     "Gas Consumption Romania, Daily, Terawatt-Hour, Not Adjusted",                              "gie",   "D",        NA,    "twh", "NA",
  "GAZCONSBG",  "cons_bg",     "Gas Consumption Bulgaria, Daily, Terawatt-Hour, Not Adjusted",                             "gie",   "D",        NA,    "twh", "NA",
  "GAZCONSLV",  "cons_lv",     "Gas Consumption Latvia, Daily, Terawatt-Hour, Not Adjusted",                               "gie",   "D",        NA,    "twh", "NA",
  "GAZCONSHR",  "cons_hr",     "Gas Consumption Croatia, Daily, Terawatt-Hour, Not Adjusted",                              "gie",   "D",        NA,    "twh", "NA",
  "GAZCONSSE",  "cons_se",     "Gas Consumption Sweden, Daily, Terawatt-Hour, Not Adjusted",                               "gie",   "D",        NA,    "twh", "NA",
  "GAZCONSDK",  "cons_dk",     "Gas Consumption Denmark, Daily, Terawatt-Hour, Not Adjusted",                              "gie",   "D",        NA,    "twh", "NA",
  "GAZCONSIE",  "cons_ie",     "Gas Consumption Ireland, Daily, Terawatt-Hour, Not Adjusted",                              "gie",   "D",        NA,    "twh", "NA",
  "GAZCONSGB",  "cons_gb",     "Gas Consumption United Kingdom, Daily, Terawatt-Hour, Not Adjusted",                       "gie",   "D",        NA,    "twh", "NA",
  "GAZCONSUA",  "cons_ua",     "Gas Consumption Ukraine, Daily, Terawatt-Hour, Not Adjusted",                              "gie",   "D",        NA,    "twh", "NA",
